...
<link href="<?= base_url() ?>template/datatable/datatables.min.css" rel="stylesheet">
...
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>template/front-end/styles/custom.css?v=<?= time() ?>">
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>template/front-end/styles/custom_course.css?v=<?= time() ?>">
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>template/front-end/styles/footer.css?v=<?= time() ?>">
