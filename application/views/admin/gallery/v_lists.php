...
<div class="col-lg-12">
    <div class="panel panel-primary">
        ...
        <a href="<?= base_url('gallery/add'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add gallery </a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('gallery/delete/'.$value->id_gallery) ?>" onclick="return confirm('Apakah Anda yakin ingin Menghapus Data ini..?')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
